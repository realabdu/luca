...
export default function CampaignsContent() {
  ...
  const hasMore = campaignsData?.hasMore ?? false;
            ...
            <tbody className="divide-y divide-border-light text-sm">
              {campaignsData === undefined ? (
                ...
                campaigns.map((campaign) => (
                  <tr key={campaign._id} className="group hover:bg-slate-50/50 transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col min-w-0">
                          ...
                          <span className="text-xs text-text-muted">
                            {campaign.externalId ? `${campaign.externalId.slice(0, 16)}...` : `ID: ${campaign._id.toString().slice(0, 8)}`}
                          </span>
                        </div>
                      </div>
                    </td>
