...
export default function TeamSettingsPage() {
  ...
  const canQuery = isConvexConfigured && isLoaded && isSignedIn && isOrgLoaded && !!clerkOrg;

  const members = useQuery(api.organizations.getMembers, canQuery ? {} : "skip");
  const organization = useQuery(api.organizations.getCurrent, canQuery ? {} : "skip");
